...
Section "ABPlayer" SEC01
  ...
  SetOutPath "$INSTDIR\_internal\werkzeug-3.0.1.dist-info"
  File "ABPlayer\_internal\werkzeug-3.0.1.dist-info\INSTALLER"
  File "ABPlayer\_internal\werkzeug-3.0.1.dist-info\LICENSE.rst"
  File "ABPlayer\_internal\werkzeug-3.0.1.dist-info\METADATA"
  File "ABPlayer\_internal\werkzeug-3.0.1.dist-info\RECORD"
  File "ABPlayer\_internal\werkzeug-3.0.1.dist-info\WHEEL"
  SetOutPath "$INSTDIR\_internal\wheel-0.42.0.dist-info"
  File "ABPlayer\_internal\wheel-0.42.0.dist-info\entry_points.txt"
  File "ABPlayer\_internal\wheel-0.42.0.dist-info\INSTALLER"
  File "ABPlayer\_internal\wheel-0.42.0.dist-info\LICENSE.txt"
  File "ABPlayer\_internal\wheel-0.42.0.dist-info\METADATA"
  File "ABPlayer\_internal\wheel-0.42.0.dist-info\RECORD"
  File "ABPlayer\_internal\wheel-0.42.0.dist-info\REQUESTED"
  File "ABPlayer\_internal\wheel-0.42.0.dist-info\WHEEL"
