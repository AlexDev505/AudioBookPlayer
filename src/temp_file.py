...
Implements interaction with a file that stores unimportant data.
...
If some rows have been modified by the user
and do not pass the data type serialization check,
then this record is ignored. All other data is loaded.
